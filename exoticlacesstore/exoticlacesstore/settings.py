...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='exoticlaces_db'),
        'USER': config('DB_USER', default='exoticlaces_user'),
        'PASSWORD': config('DB_PASSWORD', default=''),
        'HOST': config('DB_HOST', default='localhost'),
        'PORT': config('DB_PORT', default='3306'),  # Keep as string, will be converted
        'OPTIONS': {
            'charset': 'utf8mb4',
